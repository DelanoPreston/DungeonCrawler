...
public interface TileBasedMap {
	...
	/**
	 * Get the cost of moving through the given tile. This can be used to make certain areas more desirable. A simple and valid implementation of this method
	 * would be to return 1 in all cases.
	 * 
	 * @param mover
